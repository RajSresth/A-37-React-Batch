...
const ShopCardCss = ({ cardRef }) => {

    console.log("shopCardCss Render");
      
      useEffect(() => {
        console.log("useEffect CSS card")
    
        return () => console.log("cleanup css card");
      },[])
  return (
    <div className="shop-details hide" ref={cardRef}>
